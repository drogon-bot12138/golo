...
if __name__ == '__main__':
    #python train.py --device 0 --batch-size 16 --data coco.yaml --cfg yolov4-csp.cfg
    # --weights '' --name yolov4-csp
    parser = argparse.ArgumentParser(prog='test.py')
    parser.add_argument('--weights', nargs='+', type=str, default='weights/yolov4-csp.weights', help='model.pt path(s)')
